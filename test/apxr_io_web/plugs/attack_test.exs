defmodule ApxrIoWeb.Plugs.AttackTest do
  ...
  setup do
    ...
    PlugAttack.Storage.Ets.clean(ApxrIoWeb.Plugs.Attack.Storage)
    %{user: insert(:user)}
  end
  ...
  describe "throttle" do
    ...
    test "broadcasts user rate limits", %{user: user} do
      ...
      Phoenix.PubSub.broadcast!(ApxrIo.PubSub, "ratelimit", {:throttle, {:user, user.id}, time})
      Phoenix.PubSub.broadcast!(ApxrIo.PubSub, "ratelimit", {:throttle, {:user, -1}, time})
      Process.sleep(100)
    ...
    test "broadcasts ip rate limits" do
      ...
      Phoenix.PubSub.broadcast!(
        ApxrIo.PubSub,
        "ratelimit",
        {:throttle, {:ip, {3, 3, 3, 3}}, time}
      )

      Phoenix.PubSub.broadcast!(
        ApxrIo.PubSub,
        "ratelimit",
        {:throttle, {:ip, {4, 4, 4, 4}}, time}
      )
  ...
  describe "block addresses" do
    ...
    test "allows requests again when the IP is unblocked" do
      ...
      ApxrIo.Repo.delete!(blocked_address)
      ApxrIo.BlockAddress.reload()

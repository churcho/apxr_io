defprotocol ApxrIoWeb.Stale do
  def etag(schema)
  def last_modified(schema)
end

defimpl ApxrIoWeb.Stale, for: Atom do
  def etag(nil), do: nil
...
defimpl ApxrIoWeb.Stale, for: Any do
  defmacro __deriving__(module, _struct, opts) do
    ...
    quote do
      defimpl ApxrIoWeb.Stale, for: unquote(module) do
        alias ApxrIoWeb.Stale
        alias ApxrIoWeb.Stale.Any

defmodule ApxrIo.Emails.Bamboo.SESAdapter do
  require Logger
  ...
  def deliver(email, _config) do
    if email.headers != %{} do
      raise "headers not supported for ApxrIo.Emails.Bamboo.SESAdapter"
    end
...
defimpl Bamboo.Formatter, for: ApxrIo.Accounts.User do
  def format_email_address(user, _opts) do
    {user.username, ApxrIo.Accounts.User.email(user, :primary)}
  end
end

defimpl Bamboo.Formatter, for: ApxrIo.Accounts.Email do
